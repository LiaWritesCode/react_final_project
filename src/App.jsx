...
<div className="cart-icon-container" style={{ position: "relative" }}>
        ...
        {/* Restoring the exact `.total_cart_amount` element */}
<span className="total_cart_amount" style={{ display: "block", visibility: "visible" }}>
  {totalQuantity || 0}
</span>
      </div>

      {/* Ensuring product list renders correctly */}
